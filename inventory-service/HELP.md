...
* The original package name 'com.manoj.finorder.inventory-service' is invalid and this project uses 'com.manoj.finorder.inventory_service' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/data/nosql.html#data.nosql.mongodb)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/messaging/kafka.html)
